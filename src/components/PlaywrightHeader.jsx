...
export default function PlaywrightHeader({ issues, selectedFilter, onFilterChange }) {
    ...
    return (
        <div className="playwright-header">
            {/* Hero Section */}
            <div className="playwright-hero">
                <div className="hero-content">
                    <div className="hero-title-section">
                        <div className="hero-icon">🧪</div>
                        <div>
                            <h1 className="hero-title">Playwright Test Results</h1>
                            <p className="hero-subtitle">Automated Testing Dashboard</p>
                        </div>
                    </div>
                    ...
                    <div className="test-stats-grid">
                        <div className="test-stat-card">
                            ...
                            <div className="stat-content">
                                ...
                                <div className="stat-label">Total Bugs Detected</div>
                            </div>
                        </div>
                        ...
                        <div className="test-stat-card">
                            ...
                            <div className="stat-content">
                                ...
                                <div className="stat-label">Bug Types</div>
                            </div>
                        </div>
                        ...
                        <div className="test-stat-card">
                            ...
                            <div className="stat-content">
                                ...
                                <div className="stat-label">Last Test Run</div>
                            </div>
                        </div>
                    </div>
                    ...
                    {stats.total > 0 && (
                        <div className="type-breakdown">
                            <div className="breakdown-title">Bug Type Breakdown</div>
            ...
            {/* Filter Bar */}
            <div className="playwright-filters">
                <button
